...
export async function POST(req: NextRequest) {
  ...
  if (creditCost > 0) {
    ...
    await supabase.from('credit_transactions').insert({ client_id: brief.client_id, client_user_id, brief_id, amount: -creditCost, type: 'deduct', description: 'AI Express üretim' })
  }

  // Count existing children for naming
