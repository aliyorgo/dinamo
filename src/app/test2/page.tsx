      ...
      <section style={{ position: 'relative', height: '100vh', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div className="hero-inner" style={{ position: 'relative', zIndex: 2, textAlign: 'center', padding: '0 48px' }}>
          ...
          <h1 className="hero-h1" style={{
            ...
            {'Tek platform. Brief\'ten yayına.'.split('.').filter(Boolean).map((part, i) => (
          ...
          <p style={{ fontSize: '17px', fontWeight: '300', color: 'rgba(255,255,255,0.55)', lineHeight: 1.7, maxWidth: '580px', margin: '0 auto' }}>
            {"İnsan kalitesinde, AI hızında prodüksiyon. Ekibimiz strateji ve kreatif yönü kurar; AI dakikalar içinde alternatif üretir; siz fikrinizi yayına çıkmadan test edersiniz. Dinamo siz üretirken sürekli öğrenmeye devam eder, markanızı tanır, kendini geliştirir."}{' '}
            <a href="/demo-request" style={{ color: '#1DB81D', textDecoration: 'underline' }}>Demo için iletişime geçin.</a>
          </p>
        </div>
      ...
      <section style={{ background: '#0a0a0a' }}>
        <div className="s-pad" style={{ maxWidth: '1200px', margin: '0 auto', padding: '100px 48px' }}>
          <div className="grid-2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '72px', alignItems: 'center' }}>
            ...
            <div>
              <div style={{ position: 'relative', width: '52%', aspectRatio: '9 / 16', display: 'inline-block' }}>
                <video src="/videos/trend04.mp4" autoPlay muted loop playsInline style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover', borderRadius: '8px' }} />
                <img src="/overlay2_tiktok.png" alt="" aria-hidden="true" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover', pointerEvents: 'none', borderRadius: '8px' }} />
              </div>
            </div>
          </div>
