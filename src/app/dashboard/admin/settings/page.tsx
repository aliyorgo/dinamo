...
export default function SettingsPage() {
  ...
  const fields = [
    ...
    { key: 'credit_ai_express', label: 'AI Express — Satın Alma', type: 'number', unit: 'kredi' },
    { key: 'credit_ai_express_generate', label: 'AI Express — Üretme', type: 'number', unit: 'kredi' },
    { key: 'credit_ai_ugc', label: 'AI Persona — Satın Alma', type: 'number', unit: 'kredi' },
    { key: 'credit_ai_ugc_generate', label: 'AI Persona — Üretme', type: 'number', unit: 'kredi' },
    { key: 'credit_ai_animation', label: 'AI Animation — Satın Alma', type: 'number', unit: 'kredi' },
    { key: 'credit_ai_animation_generate', label: 'AI Animation — Üretme', type: 'number', unit: 'kredi' },
    { key: 'credit_ai_trend', label: 'AI Trend — Satın Alma', type: 'number', unit: 'kredi' },
    { key: 'credit_ai_trend_generate', label: 'AI Trend — Üretme', type: 'number', unit: 'kredi' },
    { key: 'credit_cta_revise', label: 'CTA Revize', type: 'number', unit: 'kredi' },
