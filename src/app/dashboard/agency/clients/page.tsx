            ...
            <div style={{ background: '#fff', border: '0.5px solid rgba(0,0,0,0.1)', borderRadius: '12px', padding: '20px', marginBottom: '20px' }}>
              ...
              <form onSubmit={addClient} style={{ display: 'flex', gap: '12px', alignItems: 'flex-end' }}>
                ...
                <button type="submit" disabled={adding}
                  style={{ padding: '8px 20px', background: '#111113', color: '#fff', border: 'none', borderRadius: '8px', fontSize: '12px', fontWeight: '500', cursor: adding ? 'not-allowed' : 'pointer', fontFamily: 'Inter,sans-serif', flexShrink: 0, height: '38px' }}>
