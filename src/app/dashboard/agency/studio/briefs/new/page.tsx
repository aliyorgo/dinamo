      ...
      <div style={{ width: '220px', background: '#111113', display: 'flex', flexDirection: 'column', flexShrink: 0, height: '100vh', position: 'sticky', top: 0 }}>
        ...
        <div style={{ padding: '10px 8px', borderTop: '0.5px solid rgba(255,255,255,0.07)' }}>
          <div onClick={() => router.push('/dashboard/agency/studio/briefs')} style={{ display: 'flex', alignItems: 'center', gap: '7px', padding: '6px 8px', borderRadius: '7px', cursor: 'pointer' }}>
            ...
            <span style={{ fontSize: '11px', color: 'rgba(255,255,255,0.25)', fontFamily: 'Inter,sans-serif' }}>Briflere dön</span>
          </div>
        </div>
      </div>
    )
      ...
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#0a0a0a', fontFamily: "'Inter',system-ui,sans-serif" }}>
        ...
        <div style={{ textAlign: 'center', maxWidth: '520px', padding: '0 24px' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', justifyContent: 'center' }}>
            <a href="/dashboard/agency/studio/briefs" style={{ padding: '13px 28px', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.15)', background: 'transparent', color: '#fff', fontSize: '14px', fontWeight: '400', textDecoration: 'none', fontFamily: 'Inter,sans-serif' }}>Tüm Briefler</a>
            <a href="/dashboard/agency/studio/briefs/new" style={{ padding: '13px 28px', borderRadius: '10px', background: '#22c55e', color: '#fff', fontSize: '14px', fontWeight: '500', textDecoration: 'none', fontFamily: 'Inter,sans-serif' }}>Yeni Brief</a>
          </div>
        </div>
      </div>
    )
                ...
                <div style={{ position: 'absolute', top: '8px', right: '8px', display: 'flex', gap: '5px', zIndex: 2 }}>
                  {prevMessage !== null && !expandLoading && (
                    <button onClick={() => { setForm(prev => ({ ...prev, message: prevMessage! })); setPrevMessage(null) }}
                      style={{ padding: '3px 8px', borderRadius: '5px', border: '1px solid rgba(0,0,0,0.12)', background: '#fff', fontSize: '10px', color: '#888', cursor: 'pointer', fontFamily: 'Inter,sans-serif' }}>
                      Geri Al
                    </button>
                  )}
