              ...
              <div style={{ width: '200px', aspectRatio: (brief?.format || '9:16').replace(':', '/'), background: '#0a0a0a', flexShrink: 0, overflow: 'hidden', position: 'relative' }}>
                {isFailed ? (
                  ...
                  <div style={{ width: '100%', height: '100%', position: 'relative', overflow: 'hidden' }}>
                    ...
                    <div style={{ position: 'absolute', left: 0, right: 0, height: '18%', zIndex: 4, backgroundImage: 'linear-gradient(to bottom, transparent 0%, rgba(255,255,255,0.0) 30%, rgba(255,255,255,0.55) 50%, rgba(255,255,255,0.0) 70%, transparent 100%)', animation: 'dinamoScanline 4s ease-in infinite', pointerEvents: 'none' as const }} />
