              ...
              <div style={{ width: '200px', aspectRatio: (brief?.format || '9:16').replace(':', '/'), background: '#0a0a0a', flexShrink: 0, overflow: 'hidden', position: 'relative' }}>
                {isFailed ? (
                  ...
                  <div style={{ width: '100%', height: '100%', position: 'relative', overflow: 'hidden' }}>
                    ...
                    <svg style={{ position: 'absolute', inset: '-5%', zIndex: 1, width: '110%', height: '110%', opacity: 0.6, mixBlendMode: 'screen' as const, animation: 'dinamoStatic 0.4s steps(4) infinite', pointerEvents: 'none' as const }} xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><filter id="dinamoNoise"><feTurbulence type="fractalNoise" baseFrequency="0.75" numOctaves="2" stitchTiles="stitch" /><feColorMatrix type="saturate" values="0" /></filter><rect width="100%" height="100%" filter="url(#dinamoNoise)" /></svg>
