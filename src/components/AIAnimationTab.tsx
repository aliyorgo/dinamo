              ...
              <div style={{ width: '200px', aspectRatio: (brief?.format || '9:16').replace(':', '/'), background: '#0a0a0a', flexShrink: 0, overflow: 'hidden', position: 'relative' }}>
                {isFailed ? (
                  ...
                  <div style={{ width: '100%', height: '100%', position: 'relative', overflow: 'hidden' }}>
                    ...
                    <div style={{ position: 'absolute', inset: 0, zIndex: 1, backgroundImage: 'radial-gradient(circle at 50% 42%, rgba(255,255,255,0.28) 0%, rgba(255,255,255,0.08) 35%, transparent 70%)', animation: 'dinamoPulseGlow 4s ease-in-out infinite' }} />
                    <div style={{ position: 'absolute', inset: 0, zIndex: 2, backgroundImage: 'radial-gradient(circle at 50% 42%, rgba(255,255,255,0.35) 0%, transparent 40%)', animation: 'dinamoGlowCore 5.5s ease-in-out infinite' }} />
