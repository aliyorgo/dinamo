      ...
      {lightbox && (
        <div onClick={() => setLightbox(null)} style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.85)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <div onClick={e => e.stopPropagation()} style={{ maxWidth: '90vw', maxHeight: '90vh' }}>
            {lightbox.type === 'video' ? (
              <video src={lightbox.url} controls controlsList="nodownload noplaybackrate" disablePictureInPicture autoPlay onPlay={e=>pauseOtherVideos(e.currentTarget)} style={{ maxWidth: '90vw', maxHeight: '90vh', display: 'block' }} />
            ) : (
