                  ...
                  {generating ? (
                    ...
                    <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column' }}>
                      ...
                      {(() => {
                        ...
                        return (
                          <>
                            <button className="dinamo-generate-btn" onClick={onClick} disabled={disabled} style={{ width: '100%', padding: '14px', marginTop: '10px', background: disabled ? '#ccc' : '#0a0a0a', color: '#fff', border: 'none', borderRadius: '2px', fontSize: '13px', fontWeight: 600, cursor: disabled ? 'not-allowed' : 'pointer', flexShrink: 0 }}>{label}</button>
                          </>
                        )
                      })()}
                    </div>
